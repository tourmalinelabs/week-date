...
describe("week-date", () => {
  ...
  describe("firstDateOfWeek", () => {
    it("should get first date of week", () => {
      expect(weekDate.firstDateOfWeek("2023-13")).to.deep.equal(new Date("2023-03-26T00:00:00.000Z").getTime());
    });
  });

  describe("lastDateOfWeek", () => {
    it("should get last date of week", () => {
      expect(weekDate.lastDateOfWeek("2023-13")).to.deep.equal(new Date("2023-04-01T00:00:00.000Z").getTime());
    });
  });
});
